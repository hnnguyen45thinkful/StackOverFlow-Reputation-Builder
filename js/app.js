//Edited and modified by Hieu Nguyen below
...
var showTopAnswerer = function(answerers) {

// clone our result template code all defined with var for the results, image, profile, posts and score and return results
var result = $('.templates .top-answerers').clone();

var answererElement = result.find('.user-name');
answererElement.text(answerers.user.display_name);
...
posts.text(answerers.post_count);
